...
public class ProdSecurityFilterConfig {
    ...
    static Logger logger = LoggerFactory.getLogger(ProdSecurityFilterConfig.class);
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://192.168.178.94:3000","http://192.168.2.132:3000"));
